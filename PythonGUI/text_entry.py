"""
How to construct and display:
  -- ttk.Entry
      that allow user to entre info
How to associate widget (here ttk.Button)
    with CALLBACK lambda function that takes Entry as ARGUMENT
How callback function can use Entry's GET and SET methods to
    get and set Entry's info
This approach is simplest way to use Entry box.

From TkinterPractice
"""
...
def print_contents(entry_box):
    """
    Prints onto Console contents of given ttk.Entry
